...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      secondaryFixed: Color(4292012243),
      onSecondaryFixed: Color(4279115538),
      secondaryFixedDim: Color(4290235576),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondary: Color(4294967295),
      secondaryContainer: Color(4284906088),
      onSecondaryContainer: Color(4294967295),
      tertiary: Color(4280043858),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4283530117),
      ...
      secondaryFixed: Color(4284906088),
      onSecondaryFixed: Color(4294967295),
      secondaryFixedDim: Color(4283261264),
      onSecondaryFixedVariant: Color(4294967295),
      tertiaryFixed: Color(4283530117),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondaryFixed: Color(4294967295),
      secondaryFixedDim: Color(4280234275),
      onSecondaryFixedVariant: Color(4294967295),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(4285372322),
